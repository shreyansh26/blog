...
![RITSEC CTF 2019](/images/ritsec_images/featured.png)
*RITSEC CTF 2019*
...
![gold-bug.jfif](https://cdn-images-1.medium.com/max/800/0*szkUp3DoP0hYUlyx)
...
![Running wget](/images/ritsec_images/3.png)
*Running wget*
...
![The webpage](/images/ritsec_images/4.png)
*The webpage*
...
![The challenge](/images/ritsec_images/5.png)
*The challenge*

Performing basic recon, we check the metadata for the image using exiftool.


![exiftool output](/images/ritsec_images/6.png)
*exiftool output*
...
![The disassembly for main](/images/ritsec_images/7.png)
...
![Character mappings](/images/ritsec_images/8.png)
*Character mappings*
